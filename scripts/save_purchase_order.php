...
PurchaseOrderRepository::set_purchase_order(ConnectionFullFillment::get_connection(), $date, $order_date, htmlspecialchars($_POST['purchase_from']), htmlspecialchars($_POST['drop_ship_to']), htmlspecialchars($_POST['purchase_order_comment']), $_POST['po_number'], $_POST['ref_quote'], $_POST['ship_via'], $_POST['terms'], htmlspecialchars($_POST['message']), $_POST['id_purchase_order']);
