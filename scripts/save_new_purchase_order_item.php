...
$purchase_order_item = new PurchaseOrderItem('', $_POST['id_purchase_order'], $_POST['part_number'], $_POST['quantity'], htmlspecialchars($_POST['description']), $_POST['unit_price'], $amount);
ConnectionFullFillment::open_connection();
PurchaseOrderItemRepository::insert_purchase_order_item(ConnectionFullFillment::get_connection(), $purchase_order_item);
