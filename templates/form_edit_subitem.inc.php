...
<div class="card-body">
  <div class="row">
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="brand_project_original" value="<?php echo $subitem->obtener_brand_project(); ?>">
      </div>
      <div class="form-group">
        ...
        <input type="hidden" name="part_number_project_original" value="<?php echo $subitem->obtener_part_number_project(); ?>">
      </div>
      <div class="form-group">
        ...
        <input type="hidden" name="description_project_original" value="<?php echo $subitem->obtener_description_project(); ?>">
      </div>
    </div>
    <div class="col-md-6">
      ...
      <div class="form-group">
        ...
        <input type="hidden" name="brand_original" value="<?php echo $subitem->obtener_brand(); ?>">
      </div>
      <div class="form-group">
        ...
        <input type="hidden" name="part_number_original" value="<?php echo $subitem->obtener_part_number(); ?>">
      </div>
      <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="quantity_original" value="<?php echo $subitem->obtener_quantity(); ?>">
  </div>
  <div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="hidden" name="website_original" value="<?php echo $subitem->obtener_website(); ?>">
  </div>
</div>
