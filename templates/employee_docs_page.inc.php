      ...
      <div class="row">
        <div class="col-md-6">
          <div class="card-documents card card-primary">
            ...
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/fullfillment/employee_docs/administration/';
              if (is_dir($directory)) {
          ...
          <div class="card-documents card card-primary">
            ...
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/fullfillment/employee_docs/brand/';
              if (is_dir($directory)) {
                  $manager = opendir($directory);
                  echo '<div class="list-group">';
                  $folder = @scandir($directory);
        ...
        <div class="col-md-6">
          <div class="card-documents card card-primary">
            ...
            <div class="card-body">
              <?php
              $directory = $_SERVER['DOCUMENT_ROOT'] . '/fullfillment/employee_docs/accounting/';
              if (is_dir($directory)) {
                  $manager = opendir($directory);
                  echo '<div class="list-group">';
                  $folder = @scandir($directory);
